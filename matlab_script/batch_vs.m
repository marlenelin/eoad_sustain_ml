...
% Define models
models = {
    'fname ~ subtypetwo*day_to_baseline + subtypethree*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + (1 + day_to_baseline|subj)', 'nocdr_s1ref';
    'fname ~ subtypeone*day_to_baseline + subtypethree*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + (1 + day_to_baseline|subj)', 'nocdr_s2ref';
    'fname ~ subtypeone*day_to_baseline + subtypetwo*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + (1 + day_to_baseline|subj)', 'nocdr_s3ref';
    'fname ~ subtypetwo*day_to_baseline + subtypethree*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + Stage_baseline + (1 + day_to_baseline|subj)', 'noscdr_s1ref_stageadj'
 'fname ~ subtypeone*day_to_baseline + subtypethree*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + Stage_baseline + (1 + day_to_baseline|subj)', 'nocdr_s2ref_stageadj'
'fname ~ subtypeone*day_to_baseline + subtypetwo*day_to_baseline + sex_baseline + age_at_pet_baseline + years_education_baseline + Centiloid_baseline + Stage_baseline + (1 + day_to_baseline|subj)', 'nocdr_s3ref_stageadj'
